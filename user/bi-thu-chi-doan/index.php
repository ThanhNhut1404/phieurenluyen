...
$base_page = $is_new_layout ? 'phieu-cham-diem' : 'bi-thu-chi-doan';
$asset_path = $is_new_layout ? '../../assets/css/user.css' : '../assets/css/user.css';
$action_path = $is_new_layout ? '../bi-thu-chi-doan/action.php?req=' : 'bi-thu-chi-doan/action.php?req=';
                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="filter" onchange="this.form.submit()">
                                        ...
                                        <option value="da_bt_cham" <?= $filter == 'da_bt_cham' ? 'selected' : '' ?>>Bí thư đã chấm</option>
                                        <option value="chua_bt_cham" <?= $filter == 'chua_bt_cham' ? 'selected' : '' ?>>Bí thư chưa chấm</option>
                                    </select>
                                </div>
                                <div class="col-md-5">
