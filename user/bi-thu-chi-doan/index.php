            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col">
                        ...
                        <a class="form-control" href="?page=bi-thu-chi-doan-tu-cham&id_dot=<?= $id_dot ?>&id_sinh_vien=<?= $id_sinh_vien ?>">Sinh
                            viên tự chấm</a>
                    </div>
                </div>
                <div class="row mb-2">
                                    ...
                                    <?php foreach ($minhchung->minhchung__Get_By_Id_Phieu($phieuchamdiem__Get_By_Id_Sinh_Vien->id_phieu) as $item) : ?>
                                        <div class="card">
                                            <div class="filtr-item no-flexed " data-category="1">
                                                <a href="bi-thu-chi-doan/image.php?id_minh_chung=<?= $item->id_minh_chung ?>" data-toggle="lightbox">
