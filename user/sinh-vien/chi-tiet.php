                ...
                <section class="content evaluation-page">
                    ...
                    <div class="evaluation-header">
                        ...
                        <div><strong>Xếp loại:</strong> <?= $ketquaxeploai__Get_By_Id_Phieu ? $ketquaxeploai__Get_By_Id_Phieu->xep_loai : "Chưa tổng kết" ?></div>
                            <div><strong>Ghi chú:</strong> <span class="text-danger" style="font-style: italic;"><?= $ketquaxeploai__Get_By_Id_Phieu ? $ketquaxeploai__Get_By_Id_Phieu->ghi_chu : "" ?></span></div>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
