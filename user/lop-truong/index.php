...
$lophoc__Get_By_Id = $lophoc->lophoc__Get_By_Id(isset($lopapdung__Get_By_Id->id_lop_hoc) ? $lopapdung__Get_By_Id->id_lop_hoc : 0);
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col">
                        ...
                        <a class="form-control" href="?page=lop-truong-tu-cham&id_dot=<?= $id_dot ?>&id_sinh_vien=<?= $id_sinh_vien ?>">Sinh
                            viên tự chấm</a>
                    </div>
                </div>
                <div class="row mb-2">
                    ...
                    <div class="col">
                        ...
                        <select class="form-control" name="id_sinh_vien" required onchange="location.href=this.value">
                            ...
                            <?php foreach ($sinhvien__Get_By_Id_Lop_Hoc_Da_Cham as $item) : ?>
                                <option value="?page=lop-truong&id_dot=<?= $id_dot ?>&id_sinh_vien=<?= $item->id_sinh_vien ?>" <?= $id_sinh_vien == $item->id_sinh_vien ? "selected" : "" ?>>
                                    <?= $item->ma_sinh_vien ?> -
                                    <?= $item->ten_sinh_vien ?>
                                </option>
                            <?php endforeach; ?>
                                                    ...
                                                    <table class="w-100">
                                                        <tbody>
                                                            ...
                                                            <tr class="border-bottom">
                                                                ...
                                                                <td class="w-10 no-border full vertical-align-middle">
                                                                    <input type="number" class="form-control kq_lt_bt" name="kq_lt_bt[]" <?= $dotchamdiem__Get_By_Id->trang_thai == 0 ? 'readonly' : '' ?> <?= $phieuchamdiem__Get_By_Id_Sinh_Vien->trang_thai != 2 ? 'readonly' : '' ?> pattern="[-+]?[0-9]{1-2}" title="max is <?= $item_2->can_tren ?>" placeholder="0" min="0" max="<?= $item_2->can_tren ?>" required value="<?= $phieuchamdiem->phieuchamdiem__Get_Ket_Qua($phieuchamdiem__Get_By_Id_Sinh_Vien->kq_lt_bt)[$i] ?>">
                                                                </td>
                                                                <td class="w-10 no-border full vertical-align-middle">
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="w-10 no-border full vertical-align-middle">
                                        <input type="number" class="form-control font-weight-bold bg-success" <?= $dotchamdiem__Get_By_Id->trang_thai == 0 ? 'readonly' : '' ?> <?= $phieuchamdiem__Get_By_Id_Sinh_Vien->trang_thai != 2 ? 'readonly' : '' ?> placeholder="0" id="sum_lt_bt" min="0" pattern="[-+]?[0-9]{1-2}" title="max is 100" max="100" readonly required>
                                    </td>
                                    <td class="w-10 no-border full vertical-align-middle">
                                    ...
                                    <?php foreach ($minhchung->minhchung__Get_By_Id_Phieu($phieuchamdiem__Get_By_Id_Sinh_Vien->id_phieu) as $item) : ?>
                                        <div class="card">
                                            <div class="filtr-item no-flexed " data-category="1">
                                                <a href="lop-truong/image.php?id_minh_chung=<?= $item->id_minh_chung ?>" data-toggle="lightbox">
