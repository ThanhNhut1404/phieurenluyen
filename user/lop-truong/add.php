...
<div class="ml-0 mr-3 content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col">
                    ...
                    <select class="form-control" name="id_sinh_vien" required onchange="location.href=this.value">
                        ...
                        <option value="?page=lop-truong&id_dot=<?=$id_dot?>&id_sinh_vien=<?=$item->id_sinh_vien?>"
    ...
    <section class="content">
        <form class="form" action="lop-truong/action.php?req=add_sv" method="post" enctype="multipart/form-data">
                            ...
                            <div class="filter-container p-0 row">
                                ...
                                <div class="card">
                                    <div class="filtr-item no-flexed " data-category="1">
                                        <a href="lop-truong/image.php?id_minh_chung=<?=$item->id_minh_chung?>"
