...
<body>
    <div class="wrapper">
                ...
                <ul class="sidebar-menu-list">
                    ...
                    <li class="sidebar-dropdown">
                        ...
                        <ul class="sidebar-submenu">
                            <li><a href="?page=thong-tin-ca-nhan">Thông tin cá nhân</a></li>
                            <li><a href="?page=doi-mat-khau">Đổi mật khẩu</a></li>
                        </ul>
                    </li>

                    <li>
                        <a href="?page=cham-diem" class="sidebar-link">
                            <i class="ri-edit-box-line"></i> Chấm điểm rèn luyện
                        </a>
                    </li>
                    <li>
        ...
        <?php 
            ...
            if ($page == 'home') {
                require "home.php";
            } else if ($page == 'cham-diem') {
                require "cham-diem.php";
