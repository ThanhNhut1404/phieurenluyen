                                                        ...
                                                        <?php if ($muc->muc__Get_By_Id($item_3->id_muc)->co_minh_chung == 1): ?>
                                                            ...
                                                            <div id="evidence-state-<?= $item_3->id_muc ?>" class="d-none">
                                                                ...
                                                                <?php foreach($minh_chung_cua_muc as $mc): ?>
                                                                    <div class="existing-evidence" data-id="<?= $mc->id_minh_chung ?>" data-url="co-van-hoc-tap/image.php?id_minh_chung=<?= $mc->id_minh_chung ?>" data-name="<?= htmlspecialchars(basename($mc->hinh_anh)) ?>"></div>
                                                                <?php endforeach; ?>
