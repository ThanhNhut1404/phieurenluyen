...
if ($mode == 'ban_than') {
    ...
    if (isset($_GET['id_sinh_vien']) && $_GET['id_sinh_vien'] != '') {
        // QuÃ¢n sá»­a: KhÃ´ng cho phÃ©p chá»n báº£n thÃ¢n lá»›p trÆ°á»Ÿng trong cháº¿ Ä‘á»™ cháº¥m cho lá»›p
...
// QuÃ¢n sá»­a: Lá»c bá» tÃ i khoáº£n cá»§a lá»›p trÆ°á»Ÿng khá»i danh sÃ¡ch cháº¥m Ä‘iá»ƒm lá»›p
if ($mode == 'lop') {
...
<div class="content-wrapper student-evaluation-wrapper">
    ...
    <section class="content evaluation-page">
        ...
        <!-- QuÃ¢n sá»­a: Äá»‹nh tuyáº¿n Ä‘Ãºng hÃ nh Ä‘á»™ng cáº­p nháº­t Ä‘iá»ƒm (Sinh viÃªn tá»± cháº¥m hoáº·c Lá»›p trÆ°á»Ÿng cháº¥m) -->
...
<td class="text-center align-middle" style="padding:4px;">
                                                    <!-- QuÃ¢n sá»­a: Chá»‰ cho phÃ©p lá»›p trÆ°á»Ÿng sá»­a cá»™t SV Tá»± Cháº¥m khi cháº¥m báº£n thÃ¢n, vÃ  ngÆ°á»£c láº¡i -->
...
window.addEventListener('load', function() {
    ...
    // QuÃ¢n sá»­a: ThÃªm sá»± kiá»‡n change Ä‘á»ƒ tÃ­nh tá»•ng Ä‘iá»ƒm Lá»›p trÆ°á»Ÿng/BÃ­ thÆ° Ä‘á»™ng
