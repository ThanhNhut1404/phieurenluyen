                ...
                <div class="row">
                    <div class="col">
                        <h3 class="card-title text-center font-weight-bold w-100 mt-3 mb-3">
                            Báº¡n khÃ´ng cÃ³ trong Ä‘á»£t nÃ y</h3>
                    </div>
                </div>
            </div>
        </div>
...
<td class="text-center align-middle" style="padding:4px;">
            ...
            <div class="card-footer">
                <?php
                    ...
                    $btn_text = $is_submitted ? "Cáº­p nháº­t minh chá»©ng" : "Ná»™p phiáº¿u Ä‘Ã¡nh giÃ¡";
...
window.addEventListener('load', function() {
    ...
    $('.kq_sv').change(function(event) {
        ...
        if (kq > 100) {
            ...
            document.getElementById("submit").setAttribute("value", "Ná»™p phiáº¿u Ä‘Ã¡nh giÃ¡");
