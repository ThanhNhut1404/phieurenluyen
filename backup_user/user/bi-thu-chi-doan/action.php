    ...
    if (isset($_GET["req"])){
        switch($_GET["req"]){
            case "add":
                ...
                // Nhá»±t sá»­a: Kiá»ƒm tra quyá»n bÃ­ thÆ° chi Ä‘oÃ n chá»‰ Ä‘Æ°á»£c cháº¥m cho sinh viÃªn cÃ¹ng lá»›p & Ä‘á»£t Ä‘ang má»Ÿ
                ...
                // QuÃ¢n sá»­a: NgÄƒn cháº·n bÃ­ thÆ° chi Ä‘oÃ n tá»± cháº¥m Ä‘iá»ƒm cho mÃ¬nh á»Ÿ cháº¿ Ä‘á»™ cháº¥m cho lá»›p (req=add)
                ...
                // Nhá»±t sá»­a: Thá»±c hiá»‡n cáº­p nháº­t Ä‘iá»ƒm cá»§a bÃ­ thÆ° chi Ä‘oÃ n vÃ  chuyá»ƒn hÆ°á»›ng thÃ nh cÃ´ng
            ...
            case "add_sv":
                ...
                // Nhá»±t sá»­a: Kiá»ƒm tra quyá»n cháº¥m há»™ cá»§a bÃ­ thÆ° chi Ä‘oÃ n vÃ  Ä‘á»£t Ä‘ang má»Ÿ
                $phieu = $phieuchamdiem->phieuchamdiem__Get_By_Id($id_phieu);
                if (!$phieu) {
                    header("location: $href&status=failed");
                    exit();
                ...
                // Xá»­ lÃ½ nÃ©n vÃ  lÆ°u áº£nh minh chá»©ng theo tá»«ng má»¥c khi bÃ­ thÆ° chi Ä‘oÃ n cháº¥m há»™
                ...
                // Nhá»±t sá»­a: Thá»±c hiá»‡n cáº­p nháº­t Ä‘iá»ƒm tá»± cháº¥m cá»§a sinh viÃªn (do bÃ­ thÆ° chi Ä‘oÃ n cháº¥m há»™) vÃ  chuyá»ƒn hÆ°á»›ng thÃ nh cÃ´ng
