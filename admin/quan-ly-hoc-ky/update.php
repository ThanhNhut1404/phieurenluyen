    ...
    <div class="col-12">
        <div class="card card-danger">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="ten_hoc_ky_update">Tên học kỳ <span class="color-crimson">(*)</span></label>
                    <input type="text" id="ten_hoc_ky_update" name="ten_hoc_ky" class="form-control" required maxlength="50"
